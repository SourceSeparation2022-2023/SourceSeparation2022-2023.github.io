...
if (configArg) {
  ...
  // get string of random int number between 0 and 4
  var randomInt = Math.floor(Math.random() * 5).toString();
  // concatenate string with default config file name
  configFile = 'configs/P3S_' + randomInt + '.yaml';
}
